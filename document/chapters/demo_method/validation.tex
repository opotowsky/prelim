...
upon first glance. \todo{expand on why}
...
at $\gamma = 0.001$.  \todo{add other two plots of nn and rr; also add in C
plots too} \todo{determine if c and gamma have any physical connection to the
data}

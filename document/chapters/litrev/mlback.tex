...
Because the creation of statistically learned models essentially occurs in a black-box,
...
Explain types of error (train, test, cv)

Measure/metric of success of machine learning tool via 3 different types of error 

Cross-Validation Error: error of model predictions versus cross-validation data (during training)

Testing Error: error of model predictions versus test data

Training Error: error of model predictions versus training data

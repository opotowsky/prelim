...
While initially uncertainties will be ignored for an approximate analysis, they
...
Including the uncertainty broadens each probability to a range of probabilities with respect to the 
The methods for
